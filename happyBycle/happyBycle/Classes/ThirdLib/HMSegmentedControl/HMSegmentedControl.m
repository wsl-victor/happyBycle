        ...
        if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
            ...
            if (!self.selectionIndicatorStripLayer.superlayer) {
                ...
                if (self.selectionStyle == HMSegmentedControlSelectionStyleBox && !self.selectionIndicatorBoxLayer.superlayer) {
                    ...
                    self.selectionIndicatorBoxLayer.cornerRadius=height/2;
...
- (CGRect)frameForFillerSelectionIndicator {
    ...
    CGFloat y=8;
    CGFloat width=self.segmentWidth-10;
    CGFloat height=CGRectGetHeight(self.frame)-16;
     CGFloat x=(self.selectedSegmentIndex+1)*5+self.selectedSegmentIndex*width+self.selectedSegmentIndex*5;
