...
#define contentViewWidthRatio 0.8
#define contentViewWidhtHeightRatio 0.8
...
-(instancetype)initWithWithView:(UIView *)customView clickCallBack:(ClickCallBack)clickCallBack andCloseCallBack:(CloseCallBack)closeCallBack
{
    if (self = [super init]) {
        [self dl_setupNewWindow];
        [self dl_setupFrameNumber];
        [self dl_setupContentView];
        [self dl_setupUIView:customView];
...
-(void)dl_setupUIView:(UIView *)view
{
